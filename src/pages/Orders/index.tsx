...
const Orders: React.FunctionComponent = () => {
	...
	const { data, isLoading } = useQuery(() => getOrders(userProfile?._id), { staleTime: 60000, cacheTime: 60000 });


	if (isLoading) return <Spinner size='medium' loading={true} isfullPage={false} />;
